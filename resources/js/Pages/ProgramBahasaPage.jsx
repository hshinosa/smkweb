                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className={`${TYPOGRAPHY.sectionHeading} mb-4`}>
                            {core_subjects?.title || "Mata Pelajaran Inti"}
                        </h2>
                        <p className={TYPOGRAPHY.bodyText}>
                            {core_subjects?.description || "Kurikulum yang dirancang untuk mengasah kemampuan komunikasi, analisis kritis, dan kreativitas."}
                        </p>
                    </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                        <div className="max-w-2xl">
                            ...
                            <p className={TYPOGRAPHY.bodyText}>
                                {facilities?.description || "Lingkungan belajar yang mendukung pengembangan kemampuan bahasa dan ekspresi seni."}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[500px]">
                        ...
                        <div className="lg:col-span-2 relative rounded-3xl overflow-hidden group shadow-lg h-full">
                            ...
                            <div className="absolute bottom-0 left-0 p-8">
                                ...
                                <h3 className="text-2xl font-bold text-white font-serif">{facilities?.main_title || "Laboratorium Bahasa Multimedia"}</h3>
                                <p className="text-gray-300 mt-2 max-w-md">{facilities?.main_description || "Dilengkapi perangkat audio-visual modern untuk latihan listening dan speaking yang efektif."}</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div>
                            <h2 className={`${TYPOGRAPHY.sectionHeading} mb-6`}>
                                {career_paths?.title || "Membuka Jalan Menuju Karir Global"}
                            </h2>
                            <p className={`${TYPOGRAPHY.bodyText} mb-10`}>
                                {career_paths?.description || "Lulusan Program Bahasa memiliki keunggulan komunikasi dan adaptabilitas budaya yang tinggi, membuka peluang karir di kancah internasional."}
                            </p>
                            ...
                            <div className="group relative flex flex-col h-full max-w-md mx-auto">
                                ...
                                <div className="bg-white rounded-3xl p-8 shadow-xl transition-all duration-300 border border-gray-100 relative -mt-12 pt-10 flex-1 flex flex-col z-10 w-full text-center">
                                    ...
                                    <blockquote className="text-gray-600 italic text-lg mb-6 leading-relaxed">
                                        "{alumni_spotlight?.quote || `Kemampuan bahasa asing yang saya asah di ${siteName} membuka peluang beasiswa ke luar negeri dan karir di perusahaan multinasional.`}"
                                    </blockquote>
                                    
                                    <div className="border-t border-gray-100 pt-6">
                                        <h3 className="font-bold text-gray-900 text-xl font-serif">{alumni_spotlight?.name || "Sarah Amalia"}</h3>
                                        <p className="text-primary font-medium text-sm">{alumni_spotlight?.description || "Alumni 2019 • Hubungan Internasional UGM"}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
