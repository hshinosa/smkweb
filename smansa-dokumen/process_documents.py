...
"""
    ...
    def _generate_summary(self) -> str:
        ...
        categories = {doc.category: len(doc) for doc in self.documents}
...
⚠️ **Catatan:** Dokumen ini untuk keperluan internal sistem RAG AI dan tidak untuk distribusi publik tanpa izin.
"""
...
def main():
    ...
    print("=" * 60)
    print("  📚 SMAN 1 BALEENDAH - Document Processor")
    print("=" * 60)
    print()
