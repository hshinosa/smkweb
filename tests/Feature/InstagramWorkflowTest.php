...
class InstagramWorkflowTest extends TestCase
{
    ...
    public function it_can_process_instagram_feed_into_news_draft_with_ai()
    {
        ...
        $mockOpenAI->shouldReceive('chatCompletion')
            ->once()
            ->andReturn([
                'success' => true,
        ...
        $post = Post::first();
        $this->assertStringContainsString('Tim basket sekolah', $post->content);
        ...
        $this->assertEquals('Juara Nasional Basket SMAN 1 Baleendah', $post->title);
